...
namespace HappyPetals
{
    public partial class Deliveries : Form
    {
        ...
        {
            InitializeComponent();
            Da = new SqlDataAdapter("select * from Deliveries ", con);
            Da.Fill(Dt);
        ...
        {
            // TODO: This line of code loads data into the 'flower_shopDataSet.Deliveries' table. You can move, or remove it, as needed.
            this.deliveriesTableAdapter.Fill(this.flower_shopDataSet.Deliveries);
